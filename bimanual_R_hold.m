function bimanual_R_hold(goalSuccessesInput)
global targetCenters targetSequence circleDiameter circleDiameter2 radii;
global centerHoldDuration centerEnterTime   centerActivated centerHoldStartTime;
global firstMove  resetPosition targetReachedOnce;
            ...
            switch op
                ...
                case 4
                    ...
                    if rTrial == trialIndex
                        ...
                        if localCenterDone && ~failInProgress
                            doBothSuccess();
                        end
                    end
            ...
            if inCenter(x, y)
                ...
                if isnan(centerHoldStartTime)
                    ...
                    if ~localCenterDone && (tNow >= centerHoldStartTime + centerHoldDuration)
                        ...
                        if remoteCenterDone && ~failInProgress
                            doBothSuccess();
                        end
